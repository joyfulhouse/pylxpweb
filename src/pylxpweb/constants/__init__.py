...
from .registers import (
    ...
    HOLD_BAT_VOLT_MIN_CHG,  # deprecated alias for HOLD_OFF_GRID_EOD_VOLTAGE
    HOLD_BAT_VOLT_MIN_DISCHG,  # deprecated alias for HOLD_LEAD_ACID_DISCHARGE_RATE
    HOLD_BAUD_RATE,
    HOLD_DAY,
    ...
    HOLD_HOUR,
    HOLD_LANGUAGE,
    # Battery charge/discharge current limits (confirmed 2026-02-18)
...
__all__ = [
    ...
    "HOLD_LEAD_ACID_CHARGE_RATE",
    "HOLD_LEAD_ACID_DISCHARGE_RATE",
    "HOLD_BAT_VOLT_MAX_DISCHG",  # deprecated alias
    "HOLD_BAT_VOLT_MIN_DISCHG",  # deprecated alias
    "HOLD_MAX_CHG_CURR",
    "HOLD_MAX_DISCHG_CURR",
    "HOLD_DISCHG_CUT_OFF_SOC_EOD",
    "HOLD_SOC_LOW_LIMIT_EPS_DISCHG",
