...
class MIDDevice(FirmwareUpdateMixin, MIDRuntimePropertiesMixin, BaseDevice):
    ...
    def __init__(
        ...
        # Note: _local_transport is inherited from BaseDevice
        # MID devices don't currently use transport for data, but the attribute
        # is needed for consistent handling in Station.attach_local_transports()
